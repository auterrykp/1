...
:root {
  ...
  --icon-fonts: 
    ...
    'Material-Design-Iconic-Font', 'Flaticon', 'icons', 'Ionicons', 'global-iconfont', 'icomoon', 'font-icons',
    'Line Awesome Free', 'simple-line-icons', 'entypo', 'HSBCIconFont', 'HSBCIcon-Font', 'HSBC Icons', 'shared-icons',
    'element-icons', 'nytcn-icon', 'octicons', 'Material Symbols Outlined', 'webflow-icons', 'SonyGwn-SystemIcons',
    'Glyphicons Halflings', 'fidelity-icon-font', 'popular-symbols', 'lite-glyphs-outlined', 'lite-glyphs-filled',
    'snaptu-symbols', 'Google Sans Flex', 'wico', 'Support MDL2 Assets', 'compass-icons-v1', 'Icons', 'header_icons',
    'smarticon', 'cx-icons', 'micon', 'iconhangseng', 'Trip Geom', 'iconfont', 'rei', 'NextIcon', 'Ay-Web-Icons-Line',
    'hkbn-icon', 'rex-icon-font', 'Genericons', 'licon', 'VideoJS', 'zozotown-icon', 'theme-icons', 'festival-walk',
    'CnNextIcon', 'icon-mo', 'Fitbit Icons', 'fricon', 'AmebaNewSymbols', 'FluentSystemIcons', 'news24', 'tipi',
    'Proxima Nova Regular', 'nine1', 'AMC Icons', 'ico', 'FabricMDL2Icons-20', 'FabricMDL2Icons', 'FabricMDL2Icons-6',
    'mui-global-iconfont', 'flight-icon', 'themify', 'qobuz-web', 'ef-icons', 'Pluto Sans', 'aweicon', 'Ginto',
    'element-pack', 'GeonauteSports', 'GeonauteIcons', 'fl-icons', 'dds-icons', 'icomoon-comm', 'fontello',
    'Material Icons Extended', 'FluentSystemIcons', 'sans-serif';
}
...
.infogram-embed, .bg-light-n2, .fly123, .cmp-lcs-stack, .posNM, .placeholder-top-desktop, #headerbannerd, #img_ybfqu8u9uru28uiurduiu6urululou9 {
